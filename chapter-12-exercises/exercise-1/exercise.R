...
avovados <- mutate(avocados, Date = as.Date(avocados$Date))
...
by_size <- avocados %>%
  select(
    Date, other_avos, small_hass, large_hass,xlarge_hass 
  )
